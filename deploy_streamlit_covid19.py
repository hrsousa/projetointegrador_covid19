...
#################################################################################################################
    with st.sidebar:
        ...
        if database == 'CSV':
            ...
            X7 = st.sidebar.selectbox('É caso proveniente de surto de Síndrome Gripal que evoluiu para SRAG? (0 - Não | 1 - Sim)',(0,1))
            X8 = st.sidebar.selectbox('Trata-se de caso nosocomial (infecção adquirida no hospital)? (0 - Não | 1 - Sim)',(0,1))
            ...
            X24 = st.sidebar.selectbox('Paciente é puérpera ou parturiente (pariu recentemente - 45 dias do parto)? (0 - Não | 1 - Sim)',(0,1))
            ...
            X33 = st.sidebar.selectbox('Paciente possui Imunodeficiência ou Imunodepressão (diminuição sistema imunológico)? (0 - Não | 1 - Sim)',(0,1))
