...
#################################################################################################################
    with st.sidebar:
        ...
        if database == 'CSV':
            ...
            X6 = st.slider('Paciente tem dor de garganta? (0 - Não | 1 - Sim)',0,1,step=1)
            X7 = st.slider('Paciente tem falta de ar? (0 - Não | 1 - Sim)',0,1,step=1)
            X8 = st.slider('Paciente tem saturação baixa? (0 - Não | 1 - Sim)',0,1,step=1)
            X9 = st.slider('Paciente tem diarreia? (0 - Não | 1 - Sim)',0,1,step=1)
            X10 = st.slider('Paciente tem vômitos? (0 - Não | 1 - Sim)',0,1,step=1)
            X11 = st.slider('Paciente tem dor abdominal? (0 - Não | 1 - Sim)',0,1,step=1)
            X12 = st.slider('Paciente tem fadiga? (0 - Não | 1 - Sim)',0,1,step=1)
            X13 = st.slider('Paciente tem perda de olfato? (0 - Não | 1 - Sim)',0,1,step=1)
            X14 = st.slider('Paciente tem perda de paladar? (0 - Não | 1 - Sim)',0,1,step=1)
            X15 = st.slider('Paciente tem problemas cardíacos? (0 - Não | 1 - Sim)',0,1,step=1)
            X16 = st.slider('Paciente tem problemas sanguíneos (trombose, anemia, linfoma e leucemia)?  (0 - Não | 1 - Sim)',0,1,step=1)
            X17 = st.slider('Paciente tem síndrome de Down? (0 - Não | 1 - Sim)',0,1,step=1)
            X18 = st.slider('Paciente tem problemas no fígado? (0 - Não | 1 - Sim)',0,1,step=1)
            X19 = st.slider('Paciente tem asma? (0 - Não | 1 - Sim)',0,1,step=1)
            X20 = st.slider('Paciente tem diabetes? (0 - Não | 1 - Sim)',0,1,step=1)
            X21 = st.slider('Paciente tem problemas neurológicos? (0 - Não | 1 - Sim)',0,1,step=1)
            X22 = st.slider('Paciente tem problemas pulmonares? (0 - Não | 1 - Sim)',0,1,step=1)
            X23 = st.slider('Paciente tem imunodepressão (HIV/Câncer)? (0 - Não | 1 - Sim)',0,1,step=1)
            X24 = st.slider('Paciente tem problemas nos rins? (0 - Não | 1 - Sim)',0,1,step=1)
            X25 = st.slider('Paciente é obeso? (0 - Não | 1 - Sim)',0,1,step=1)
