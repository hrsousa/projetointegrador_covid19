...
#################################################################################################################
    with st.sidebar:
        ...
        if database == 'CSV':
            ...
            X4 = st.sidebar.selectbox('4. Cor ou raça declarada pelo paciente (0 - Não | 1 - Sim)',(0,1))
            X5 = st.sidebar.selectbox('5. Nível de escolaridade do paciente (0 - Não | 1 - Sim)',(0,1))
            X6 = st.sidebar.selectbox('6. Tem histórico de viagem internacional nos últimos 14 dias? (0 - Não | 1 - Sim)',(0,1))
            ...
            X39 = st.sidebar.selectbox('39. Paciente fez uso de suporte ventilatório (ventilação mecânica)? (0 - Não | 1 - Sim)',(0,1))
            X40 = st.sidebar.selectbox('40. Informar resultado de Raio X de tórax (0 - Não | 1 - Sim)',(0,1))
            X41 = st.sidebar.selectbox('41. Informar resultado da tomografia (0 - Não | 1 - Sim)',(0,1))
            X42 = st.sidebar.selectbox('42. Resultado do teste de RT-PCR/outro método por Biologia Molecular (0 - Não | 1 - Sim)',(0,1))
            X43 = st.sidebar.selectbox('43. Resultado da Sorologia para SARS-CoV-2 (IgA) (0 - Não | 1 - Sim)',(0,1))
            X44 = st.sidebar.selectbox('44. Resultado da Sorologia para SARS-CoV-2 (IgG) (0 - Não | 1 - Sim)',(0,1))
            X45 = st.sidebar.selectbox('45. Resultado da Sorologia para SARS-CoV-2 (IgM) (0 - Não | 1 - Sim)',(0,1))
